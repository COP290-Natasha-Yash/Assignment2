...
// Handles GET /:id/boards/:boardId/columns/:columnId/tasks — retrieves all tasks in a column
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      // Fetching all tasks in the column including their subtasks and assignee info
