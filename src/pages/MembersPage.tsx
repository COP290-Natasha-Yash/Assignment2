...
function MembersPage() {
  ...
  const [view, setView] = useState<"members" | "addUser" | "userProfile">(
    "members"
  );
  ...
  const fetchCurrentUser = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // No sessionStorage — cookie is the auth source of truth
      }
    } catch {
  ...
  const fetchMyProjectRole = async () => {
    // Use currentUser from state (already populated by fetchCurrentUser in init())
    // instead of reading from sessionStorage — avoids stale cross-tab data.
    if (currentUser.role === "GLOBAL_ADMIN") return; // skip — doesn't need membership
    ...
    setConfirmModal({
      ...
      onConfirm: async () => {
        try {
          ...
          showToast("Network error: Could not remove member.", "error");
        }
      },
    });
  };
        ...
        <div className={styles.membersLayout}>
          ...
          <div className={styles.membersPanel}>
            <div className={styles.panelHeader}>
              <h2 className={dashStyles.projectsTitle}>
              ...
              {canManage && (
                <button
                  ...
                  onClick={() =>
                    setView(view === "addUser" ? "members" : "addUser")
                  }
                >
                  ...
                  <div key={member.id} className={styles.memberRow}>
                    ...
                    {canManage ? (
                      <select
                        ...
                        value={member.role}
                        style={{
                          borderColor: roleColors[member.role] + "55",
            ...
            <div className={styles.addPanel}>
              ...
              <div className={styles.addRoleRow}>
                ...
                <select
                  ...
                  value={addRoleSelect}
                  onChange={(e) =>
                    setAddRoleSelect(e.target.value as ProjectRole)
                  }
                >
                  <option value="ADMIN">ADMIN</option>
                  <option value="MEMBER">MEMBER</option>
                ...
                {filteredAllUsers.length === 0 ? (
                  ...
                  filteredAllUsers.map((u) => (
                    <div
                      ...
                      onClick={() => {
                        setSelectedUser(u);
                        setProfileAddRole(addRoleSelect);
                        setView("userProfile");
                      }}
                    >
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          handleAddMember(u, addRoleSelect);
                        }}
                      >
                        + Add
                      </button>
            ...
            <div className={styles.addPanel}>
              ...
              <div className={styles.profileView}>
                <Avatar
                  ...
                  size={72}
                />
                <h2 style={{ marginTop: "12px", color: "#1e293b" }}>
                  {selectedUser.name}
                </h2>
                ...
                >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setProfileAddRole(e.target.value as ProjectRole)
                    }
                  >
                    <option value="ADMIN">ADMIN</option>
                    <option value="MEMBER">MEMBER</option>
                ...
                <div className={dashStyles.inputGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (f) setEditProfile({ ...editProfile, avatarFile: f });
                    }}
                  />
                  {currentUser.avatar && (
                    <img
